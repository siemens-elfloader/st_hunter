 ...
 */
#ifdef IF2
 UWord8 block_size[16]= {18, 23, 33, 37, 41, 47, 51, 59, 61, 6, 6, 0, 0, 0, 1, 1};
#else
 UWord8 block_size[16]= {18, 24, 33, 37, 41, 47, 51, 59, 61, 6, 6, 0, 0, 0, 1, 1};
#endif
/*
 * tables
 */

 Word16 mode_7k[NBBITS_7k << 1] = {
