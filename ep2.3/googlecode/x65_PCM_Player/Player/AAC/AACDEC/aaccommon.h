...
void aacFreeBuffers(AACDecInfo *aacDecInfo);
...
int aacDequantize(AACDecInfo *aacDecInfo, int ch);
...
int aacIMDCT(AACDecInfo *aacDecInfo, int ch, int chBase, short *outbuf);
