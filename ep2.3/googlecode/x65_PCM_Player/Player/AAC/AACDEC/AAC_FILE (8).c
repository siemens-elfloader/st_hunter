/* ***** BEGIN LICENSE BLOCK *****  
 * Source last modified: $Id: sbrside.c,v 1.1 2005/02/26 01:47:35 jrecker Exp $ 
 *   
...
{
	int numEnvRaw, env, rel, pBits, border, middleBorder;
	unsigned char relBordLead[MAX_NUM_ENV], relBordTrail[MAX_NUM_ENV];
	unsigned char relBorder0[3], relBorder1[3], relBorder[3];
	unsigned char numRelBorder0, numRelBorder1, numRelBorder, numRelLead, numRelTrail;
	unsigned char absBordLead, absBordTrail, absBorder;
