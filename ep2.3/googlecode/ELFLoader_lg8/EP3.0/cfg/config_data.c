...
__root CFG_HDR cfghdr03_01={CFG_CHECKBOX,"First Lib Load",0,0};
...
__root CFG_HDR cfghdr05_01={CFG_CHECKBOX,"Enable Log Sound",0,0};
__root int log_sound = 1;

__root CFG_HDR cfghdr05_02={CFG_CHECKBOX,"SUBPROC Daemons",0,0};
__root int subproc_daem = 1;

__root CFG_HDR cfghdr05_03 = {CFG_UINT, "SUBPROC Prio", 1, 255};
