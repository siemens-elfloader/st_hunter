...
typedef struct DRWOBJ
{
  char dummy[0x24];
} DRWOBJ;

typedef struct WSHDR
{
...
typedef struct REGEXPLEXT_ARM_NEW
{
  int zero;
...
#pragma pack(2)
typedef struct REGSOCKCEPID_DATA
{
...
typedef struct CTX_NAPDEF
{
  char body[0x204];
} CTX_NAPDEF;

typedef struct NAP_PARAM_CONT
{
  unsigned int len;
...
typedef struct TDateTimeSettings
{
...
typedef struct NativeExplorerData
{
...
#pragma swi_number=31
__swi	__arm void DrawMainScreen();

#pragma swi_number=32
__swi	__arm void DrawScreenSaver ();
...
#pragma swi_number=0x9C
__swi __arm void CloseScreensaver ();
...
///§Ў§Я§С§Э§а§Ф RAMCAP, §Я§а §Т§Ц?§Щ§С§б§С§в§Ь?§Я§С?§в§С§Ю§а?
...
__swi __arm void SetCpuClockLow(int flag);

#pragma swi_number=0x222
__swi __arm void SetCpuClockHi(int flag);
...
__swi __arm void InitTime(TTime *time, unsigned char hour, unsigned char min, unsigned char sec, unsigned long millisec);
//thumb
...
#pragma swi_number=0x038
__swi __arm int Registry_GetHMIKeyID(char *Keyword);

#pragma swi_number=0x039
__swi __arm void Registry_SetResourcePath(int HMIKeyID, int Prio, WSHDR *Path);

#pragma swi_number=0x03A
__swi __arm void Registry_DeleteResourcePath(int HMIKeyID, int Prio);

#pragma swi_number=0x03E
__swi __arm void Registry_GetResourcePathFromLevel(int HMIKeyID1, int Prio, int *HMIKeyID2, WSHDR *Path);

#pragma swi_number=0x004B
__swi __arm void StartMidlet(char*);
...
__swi __arm char *RamRingtoneStatus();
...
#pragma swi_number=0x829D
__swi __arm char *RamDisplayLanguage();
...
//thumb
//pattern=80,BD,80,B5,09,68,00,68,??,F0,??,F?,80,BD,+3

#pragma swi_number=0x2E3
__swi __arm int fexists(WSHDR* FileName);
//pattern_ELKA=04,E0,2D,E5,24,D0,4D,E2,20,20,8D,E2,04,10,8D,E2,??,??,??,EB,00,00,50,E3,BC,01,DD,01
//pattern_NSG=80,B5,88,B0,07,AA,69,46,??,??,??,??,00,28,03,D1,+1

#pragma swi_number=0x2E4
 __swi __arm  int SettingsAE_Update_ws(WSHDR *,int set,char * entry,char *keyword);
//thumb
//pattern_NSG/ELKA=F0,B5,16,1C,0D,1C,1C,1C,00,28,9B,B0,+1

#pragma swi_number=0x2E5
 __swi __arm  int SettingsAE_Read_ws(WSHDR *,int set,char * entry,char *keyword);
//thumb
//pattern_NSG/ELKA=F0,B5,0F,1C,16,1C,1D,1C,04,1C,00,28,9B,B0,+1

#pragma swi_number=0x2E6
 __swi __arm  int SettingsAE_SetFlag(int val,int set,char * entry,char *keyword);
//thumb
//pattern_NSG/ELKA=80,B5,00,28,??,D0,??,A0,??,E0,+1

#pragma swi_number=0x2E7
 __swi __arm  int SettingsAE_GetFlag(int *res,int set,char * entry,char *keyword);
//thumb
//pattern_NSG/ELKA=BC,B5,04,1C,10,1C,1A,1C,00,2C,??,??,00,25,25,60,03,1C,+1

#pragma swi_number=0x2E8
 __swi __arm  int SettingsAE_Update(int val,int set,char * entry,char *keyword);
//thumb
//pattern_NSG/ELKA=FE,B5,0D,1C,16,1C,1C,1C,02,1C,68,46,??,??,??,??,??,??,23,1C,32,1C,+1

#pragma swi_number=0x2E9
 __swi __arm  int SettingsAE_Read(int *res,int set,char * entry,char *keyword);
//thumb
//pattern_NSG/ELKA=BF,B5,04,1C,10,1C,1A,1C,00,2C,??,??,00,25,25,60,03,1C,+1

#pragma swi_number=0x2EA
 __swi __arm  void* SettingsAE_GetEntryList(int set);
//thumb
//pattern_NSG/ELKA=F0,B5,8?,B0,05,1C,0E,20,00,AB,18,7?,0C,20,68,43,+1

#pragma swi_number=0x2EB
 __swi __arm  int SettingsAE_RemoveEntry(int set,char *entry,int flag);
//thumb
//pattern_NSG/ELKA=F0,B5,07,1C,0D,1C,00,2A ,A1,B0,+1

#pragma swi_number=0x2EC
__swi __arm int i2c_transfer(I2C_MSG *msg);

//pattern_NSG/ELKA=02,20,A0,E3,A4,00,A0,E3,-0x1C
//pattern_SGOLD=04,00,95,E5,00,00,50,E3,01,00,A0,03,-0x28

#pragma swi_number=0x2ED
__swi __arm int i2c_receive(I2C_MSG *msg);
//pattern_NSG/ELKA= 02,20,A0,E3,B4,00,A0,E3,-0x1C
//pattern_SGOLD=04,00,95,E5,00,00,50,E3,02,00,A0,03,-0x28

#pragma swi_number=0x8299
__swi __arm char *RamExtendedCameraState();

#pragma swi_number=0x829C
__swi __arm char *RamInputLanguage();
