...
__root const unsigned int UIN=5727835;

__root const CFG_HDR cfghdr1={CFG_STR_PASS,"Password",0,8};
__root const char PASS[9]="Dacemana";

//Network settings
__root const CFG_HDR cfghdr2={CFG_LEVEL,"Hosts and paths",1,0};
  __root const CFG_HDR cfghdr2_1={CFG_STR_WIN1251,"Host",0,127};
  __root const char NATICQ_HOST[128]="himoza.zyns.com; 212.17.23.124; wolf666.ru; pentium02.net.ru; cbsie.dyndns.info; freegw.alltime.ru";
...
//Buffer for fill from history
  ...
  __root const int HISTORY_BUFFER = 0;
...
__root const CFG_HDR cfghdr8={CFG_LEVEL,"Notify power",1,0};
  ...
  __root const CFG_HDR cfghdr8_5={CFG_LEVEL,"Sounds setup",1,0};
    ...
    __root const char sndStartup[64]="2:\\ZBin\\NatICQ\\Sounds\\sndStartup.wav";
  
    __root const CFG_HDR cfghdr8_5_2={CFG_STR_UTF8,"snd SrvMsg",0,63};
    __root const char sndSrvMsg[64]="2:\\ZBin\\NatICQ\\Sounds\\sndSrvMsg.wav";
  
    __root const CFG_HDR cfghdr8_5_3={CFG_STR_UTF8,"snd Global",0,63};
    __root const char sndGlobal[64]="2:\\ZBin\\NatICQ\\Sounds\\sndGlobal.wav";
  
    __root const CFG_HDR cfghdr8_5_4={CFG_STR_UTF8,"snd Msg",0,63};
    __root const char sndMsg[64]="2:\\ZBin\\NatICQ\\Sounds\\sndMsg.wav";
  
    __root const CFG_HDR cfghdr8_5_5={CFG_STR_UTF8,"snd MsgSent",0,63};
    __root const char sndMsgSent[64]="2:\\ZBin\\NatICQ\\Sounds\\sndMsgSent.wav";
