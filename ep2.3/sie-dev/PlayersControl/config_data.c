...
__root const CFG_HDR cfghdr1_1={CFG_CHECKBOX,"Использовать стандартный плеер?",0,0};
__root const  int player0=1;

__root const CFG_HDR cfghdr1_2={CFG_CHECKBOX,"Использовать Ivoplay?",0,0};
__root const  int player1=0;

__root const CFG_HDR cfghdr1_3={CFG_CHECKBOX,"Использовать MusicAPlayer?",0,0};
__root const  int player2=0;

__root const CFG_HDR cfghdr1_4={CFG_CHECKBOX,"Использовать SPlayer?",0,0};
...
__root const CFG_HDR cfghdr1_6={CFG_STR_UTF8,"Картинка стд. плеера(или цифра)",0,255};
#ifdef ELKA 
__root const char PATH_STDICON[256]="518";
#else
#ifdef NEWSGOLD
__root const char PATH_STDICON[256]="838";
#else
__root const char PATH_STDICON[256]="838";
#endif
#endif

__root const CFG_HDR cfghdr1_7={CFG_STR_UTF8,"Картинка Ivoplay(или цифра)",0,255};
__root const char PATH_IVOICON[256]="4:\\ZBin\\Ivoply\\Ivoplay.png";

__root const CFG_HDR cfghdr1_8={CFG_STR_UTF8,"Картинка MusicAPlayer(или цифра)",0,255};
__root const char PATH_MAICON[256]="4:\\ZBin\\MusicaPlayer\\MusicaPlayer.png";

__root const CFG_HDR cfghdr1_9={CFG_STR_UTF8,"КартинкаSPlayer(или цифра)",0,255};
__root const char PATH_SPICON[256]="4:\\ZBin\\SPlayer\\SPlayer.png";
...
__root const CFG_HDR cfghdr15_3={CFG_CBOX,"Частота опроса (сек)",0,3};
__root const unsigned int HeadseTimeOut=1;
__root const CFG_CBOX_ITEM cfgcbox15_3[]={"1","2","3"};


__root const CFG_HDR cfghdr15_4={CFG_CHECKBOX,"Обрабатывать при влючении?",0,0};
__root const  int OnOn =0;
...
__root const CFG_HDR cfghdr_m51={CFG_LEVEL,"Оверлей теги (Не работает!!!)",1,0};

__root const CFG_HDR cfghdr16 = {CFG_STR_WIN1251,"Воспроизведение CSM(csmlist.txt)",1,8};
#ifdef ELKA
__root const char CsmAdr[9]="A087109C"; //for e71v45
#else
__root const char CsmAdr[9]="A068E244"; //for s75v47
#endif
__root const CFG_HDR cfghdr17={CFG_RECT,"Позиция",0,0};
#ifdef ELKA
__root const RECT TAGSPOS={0,0,239,21};
#else
__root const RECT TAGSPOS={0,0,131,16};
#endif


__root const CFG_HDR cfghdr18={CFG_UINT,"Шрифт",0,255};
#ifdef ELKA
__root const int FONT=9;
#else
__root const int FONT=5;
#endif
__root const CFG_HDR cfghdr19={CFG_COLOR,"Цвет",0,255};
__root const char COLOR[4]={21,21,21,21};

__root const CFG_HDR cfghdr22={CFG_CBOX,"Метод",0,3};
__root const int TAGSType=0;
__root const CFG_CBOX_ITEM cfgcbox22[]={"При переключении","Всегда","Не использовать"};
