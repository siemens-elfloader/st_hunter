...
__root const CFG_HDR cfghdr0={CFG_CHECKBOX,"Enable GprsD",0,2};
__root const int ENA_GPRSD = 1;

__root const CFG_HDR cfghdr8={CFG_CHECKBOX,"Control GPRS on/off",0,2};
__root const int GPRS_CTL = 1;
