...
__root const unsigned int main_lenght = 38;
...
__root const unsigned int ping_time_config = 5;
...
__root const CFG_HDR cfghdr8={CFG_LEVEL,"Notify power",1,0};
  ...
  __root const CFG_HDR cfghdr8_5={CFG_LEVEL,"Sounds setup",1,0};
    ...
    __root const char pingsnd[64]=DEFAULT_DISK ":\\ZBin\\NatICQ\\Sounds\\ping.wav";
