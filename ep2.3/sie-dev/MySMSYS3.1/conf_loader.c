...
{
  if(LoadConfigData("4:\\ZBin\\etc\\Mss31.bcfg")<0)
  {
    LoadConfigData("0:\\ZBin\\etc\\Mss31.bcfg");
  }
  /*
#ifdef MEGADIAL
  if (LoadConfigData("4:\\ZBin\\etc\\MssMD.bcfg")<0)
  {
    LoadConfigData("0:\\ZBin\\etc\\MssMD.bcfg");
  }
#else
  if (LoadConfigData("4:\\ZBin\\etc\\MySMSYS.bcfg")<0)
  {
    LoadConfigData("0:\\ZBin\\etc\\MySMSYS.bcfg");
  }
#endif*/
}
