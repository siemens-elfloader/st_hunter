...
__root const CFG_HDR cfghdr1_1_1 = {CFG_CHECKBOX, LGP_CFG_ENA_PRE, 0, 3};
__root const int CFG_ENA_PRE = 1;

__root const CFG_HDR cfghdr1_1_2 = {CFG_CHECKBOX, LGP_CFG_ENA_SCREEN, 0, 3};
__root const int CFG_ENA_SCREEN = 1;
