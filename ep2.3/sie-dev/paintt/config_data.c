...
__root const CFG_HDR cfghdr_m01={CFG_LEVEL,"Стартовый размер картинки",1,0};

	__root const CFG_HDR cfghdr001={CFG_INT,"Ширина (x)",0,0xff};
	__root const unsigned int DEF_W=48;

	__root const CFG_HDR cfghdr002={CFG_INT,"Высота (y)",0,0xff};
...
__root const CFG_HDR cfghdr_m11={CFG_LEVEL,"Цвет фона прозрачности",1,0};
	__root const CFG_HDR cfghdr5={CFG_COLOR,"Цвет 1",0,0};
	__root const char B_COL_1[4]={0,255,255,100};

	__root const CFG_HDR cfghdr101={CFG_COLOR,"Цвет 2",0,0};
	__root const char B_COL_2[4]={255,140,255,100};
	
	__root const CFG_HDR cfghdr102={CFG_INT,"Размер квадратов фона",0,20};
