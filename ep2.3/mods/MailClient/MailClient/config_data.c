...
__root const CFG_HDR cfghdr15={CFG_STR_UTF8,"font path",3,63};
__root const char fontpath[64]="4:\\elf\\naticq\\font\\";

__root const CFG_HDR cfghd67 = {CFG_COORDINATES,"Координаты",0,0};
__root const unsigned int X = 2;
__root const unsigned int Y = 65;

__root const CFG_HDR cfghdr298 = {CFG_CBOX,"Align",0,3};
__root const int align = 0;
__root const CFG_CBOX_ITEM cfgcbox86[3]={"Left","Center","Right"};
