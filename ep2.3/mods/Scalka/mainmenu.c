...
extern void ShowConvertMenu(GUI *gui);
extern void ConvertRezult(GUI *gui);
...
static MENUITEM_DESC mmenu_ITEMS[MAIN_MENU_ITEMS_N]=
{
  ...
  {NULL,(int)"Перевести число",    LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //1
  {NULL,(int)"Перевести рузультат",    LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //2
  {NULL,(int)"Об эльфе",    LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2} //3
