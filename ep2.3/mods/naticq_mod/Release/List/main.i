...
{
  comanda=1;
  sprintf(mod_info,"mod by Evilfox,kluchnik,windes based on revision 2058, mod date: %s at %s ","Dec 19 2010","16:45:02");
  ...
  if(!strcmp(txt, "GET_URL_INFO") || !strcmp(txt, "__URL"))
  {
    ...
    sprintf(send_txt,"revision 2058, mod date: %s at %s ",
                     "http://kluchnik.jino-net.ru/naticqmod/","Dec 19 2010","16:45:02");
...
void method0(MAIN_GUI *data)
{
  ...
  {  
    ...
    DrawString(data->ws1,2,(0)+2,scr_w-1,(0)+GetFontYSIZE(11),11,0,fntSelect,0);
    DrawList(); 
  }
