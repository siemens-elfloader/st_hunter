...
void new_redraw(void *data)
{
  ...
  DrawRectangle(0,(0),ScreenW()-1,ScreenH()-1,0,prozr,prozr); 
...
{
  comanda=1;
  sprintf(mod_info,"mod by Evilfox,kluchnik,windes based on revision 2058 from ОлежкО64, mod date: %s at %s ","Jun 29 2008","17:08:02");
  ...
  if(!strcmp(txt, "GET_URL_INFO") || !strcmp(txt, "__URL"))
  {
    ...
    sprintf(send_txt,"revision 2058, mod date: %s at %s ",
                     "http://kluchnik.jino-net.ru/naticqmod/","Jun 29 2008","17:08:02");
