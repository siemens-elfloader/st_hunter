...
__root const CFG_HDR cfghdr668 = {CFG_CBOX,"Auto Status (on/off)",0,2};
__root const unsigned int AUTO_ENGADE = 1;
...
//Status icon on mainscreen position
  ...
  __root const unsigned int IDLEICON_X=110; //2
  __root const unsigned int IDLEICON_Y=52;  //62
...
__root const unsigned int ONTIME_X = 32;
__root const unsigned int ONTIME_Y = 78;  
...
__root const CFG_HDR cfghdr1qt = {CFG_CBOX,"Show Main Msg",0,2};
__root const int Is_DRAWMAIN_On = 0;
...
__root const unsigned int PING_X = 32;
__root const unsigned int PING_Y = 68;
...
__root const unsigned int UNREAD_X = 73;
__root const unsigned int UNREAD_Y = 26;
