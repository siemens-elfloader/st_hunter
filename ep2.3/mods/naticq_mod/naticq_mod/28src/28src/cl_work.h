...
//CLIST *AddContact(unsigned int uin, char *name); //2058
CLIST *AddContact(unsigned int uin, char *name, unsigned int group, int local);//2058
CLIST *AddGroup(unsigned int grp, char *name);

void LoadLocalCL(void); //2058
