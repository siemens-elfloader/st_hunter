...
static const int mmenusoftkeys[]={0,1,2};
    ...
    #else
      #define MENU_ITEMS 21//static const char * const menutexts[22]=//Переходим к универсальности!!!
    #endif
  #else
      #define MENU_ITEMS 20//static const char * const menutexts[19]=
  #endif
#else
  #define MENU_ITEMS 18//static const char * const menutexts[19]=
#endif
