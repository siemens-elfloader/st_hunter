...
__root const CFG_HDR cfghdr_m61={9,"Автостатус",1,0};
    ...
    __root const CFG_HDR cfghdrzz_9={4,"Сообщение отсутствия",0,1023};
    __root const char awayMsg[1024]="я сейчас не могу ответить!";
...
__root const CFG_HDR cfghdr_m51={9,"Экстра опции",1,0};
    ...
    __root const CFG_HDR cfghdr467 = {5,"Показывать в заголовке КЛ",0,5};
    __root const int TIME_OR_MSG = 4;
    __root const CFG_CBOX_ITEM cfgcbox91[5]={"Время","Сообщения","Контакты","Все","Пнг шрифт(все)"};
