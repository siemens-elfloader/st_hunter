...
void Draw2()
{
  ...
  DrawString(ws,ScreenW()-Get_WS_width(ws,11)-2,igrek,ScreenW()-1,igrek+GetFontYSIZE(11),11,4,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void Draw3()
{
  ...
  DrawString(ws,ScreenW()-Get_WS_width(ws,11)-2,igrek,ScreenW()-1,igrek+GetFontYSIZE(11),11,0,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void reftes()
{
  ...
  DrawRectangle(0,(24),scr_w,scr_h+(24),0,GetPaletteAdrByColorIndex(color_SS),GetPaletteAdrByColorIndex(color_SS)); 
  ...
  if(away_m) 
  {
    wsprintf(ws,"Autostatus %s",away_msg_time_dace);
    DrawString(ws,2,y,ScreenW()-1,igrek+GetFontYSIZE(11),11,0,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
    y+=GetFontYSIZE(11)+5;
  }
    
  if(CurrentPrivateStatus==1) 
   {
    wsprintf(ws,"Invisable");
    DrawString(ws,2,y,ScreenW()-1,igrek+GetFontYSIZE(11),11,0,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
    y+=GetFontYSIZE(11)+5;
  }
  ...
  if(Is_Double_Vibra_On)
   {
    wsprintf(ws,"Vibra remaind enable");
    DrawString(ws,2,y,2+Get_WS_width(ws,11)-2,igrek+GetFontYSIZE(11),11,0,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
   }
...
static void method1(SCREEN_GUI *data,void *(*malloc_adr)(int))
{
  data->ws=AllocWS(50);
  data->gui.state=1;
  DrawRectangle(0,(24),ScreenW()-1,ScreenH()-1,0,
