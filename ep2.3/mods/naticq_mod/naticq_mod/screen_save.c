...
void Draw2()
{
  ...
  DrawString(ws,ScreenW()-Get_WS_width(ws,11)-2,igrek,ScreenW()-1,igrek+GetFontYSIZE(11),11,TEXT_ALIGNRIGHT,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void Draw5()
{
  ...
  DrawString(ws,0,YDISP+15,ScreenW()-1/*40+Get_WS_width(ws,11)+2*/,40+GetFontYSIZE(11),11,TEXT_ALIGNMIDDLE,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void reftes()
{
  ...
  DrawRectangle(0,YDISP,scr_w,scr_h+YDISP,0,GetPaletteAdrByColorIndex(color_SS),GetPaletteAdrByColorIndex(color_SS)); 
