...
__root const CFG_HDR cfghdr_m61={CFG_LEVEL,"Автостатус",1,0};
    ...
    __root const CFG_CBOX_ITEM cfgcboxa1_153[13]={"В сети", "Отошел", "Недоступен", "Не беспокоить", "Занят", "Готов болтать", "Невидимый", "Депрессия", "Злой", "Дома", "Жру","На работе","Выключен"};

    
    __root const CFG_HDR cfghdr667={CFG_UINT,"Время (1min=12)",60,500};
    __root const unsigned int AUTO_ENGADE=240;
    
    __root const CFG_HDR cfghdr61_8={CFG_UINT,"Количество ответов",0,150};
...
__root const CFG_HDR cfghdr11_10={CFG_STR_UTF8,"Мое имя",0,255};
__root const char myName[256]="I";
