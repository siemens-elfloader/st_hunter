...
void InitConfig()
{
  if (LoadConfigData("4:\\ZBin\\etc\\NATICQ_4249289.bcfg")<0)
  {
    LoadConfigData("0:\\ZBin\\etc\\NATICQ_4249289.bcfg");
  }
}
*/
void InitConfig()
{
  if (LoadConfigData("4:\\ZBin\\etc\\NATICQ_5727835.bcfg")<0)
  {
    LoadConfigData("0:\\ZBin\\etc\\NATICQ_mod1.bcfg");
  }
}
