...
__root const CFG_HDR cfghdr_c_3={CFG_CHECKBOX,"Gorizontal mode",0,2};
__root const int IDLE_GORIZO = 0;

__root const CFG_HDR cfghdr6931={CFG_UINT,"Activation sound",0,65535};
...
__root const CFG_HDR cfghdr69={CFG_UINT,"Panel lenght",0,320};
...
__root const CFG_HDR cfghdr167c={CFG_LEVEL,"Constants",1,0};

__root const CFG_HDR cfghdr692f={CFG_CBOX,"Formula",0,1};
...
__root const CFG_HDR cfghdr389r={CFG_UINT,"R",0,65535};
__root const int R1=0;
