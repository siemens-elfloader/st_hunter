...
__root const CFG_HDR cfghdrI_1={9,"Интерфейс",1,0};

  __root const CFG_HDR cfghdrI_4 = {1, "Кол-во сообщений в чате", 0, 75};  
  __root const unsigned int MAXLOGMSG = 20;    
  
  
   __root const CFG_HDR cfghdrI_2={11,"Два столбца",0,2};
   __root const int VIEW_MODE = 1;
          
  __root const CFG_HDR cfghdrI_3={11,"Две линии",0,2};
  __root const int LINE_MODE = 0;
  
  __root const CFG_HDR cfghdrI_7={5,"Показывать",0,3};
  __root const unsigned int SOFT_MODE = 1;
  __root const CFG_CBOX_ITEM cfgcboxI_8[3]={"Ничего","Софты","Инфу"};
  
  __root const CFG_HDR cfghdrI_5={11,"Статусы в иконбаре",0,2};
  __root const unsigned int ShowStatusToIconBar = 1;
  
  __root const CFG_HDR cfghdrI_6={11,"Пинг в иконбаре",0,2};
  __root const unsigned int PingToIconBar = 0;
  

  

  __root const CFG_HDR cfghdrI_8={5,"Показывать отправку",0,4};
  __root const unsigned int ShowProcessSend = 1;
  __root const CFG_CBOX_ITEM cfgcboxI_9[4]={"Ничего","Цифрами","Линией","Цифры+Цвет"};  
  
  
  __root const CFG_HDR cfghdr6_8={5,"Показывать активные чаты",0,2};
  __root const int SHOW_ACTIVE = 1;
  __root const CFG_CBOX_ITEM cfgcbox6_8[2]={"No","Yes"};  
  
  __root const CFG_HDR cfghdrI_10={5,"Выделять активные чаты",0,2};
  __root const int SelBoldActiveChat = 1;
  __root const CFG_CBOX_ITEM cfgcboxI_11[2]={"Обычным","Жирным"};  
    
  __root const CFG_HDR cfghdrI_9={11,"Подсветка при подключении конт.",0,2};
  __root const unsigned int IllByONCantact = 1;
          
  __root const CFG_HDR cfghdr2_7={2,"Small images .png path",0,63};
  __root const char ICON_PATH2[64]= "4" ":\\ZBin\\NatICQ\\img2";





__root const CFG_HDR cfghdr_s1={9,"Заголовок КЛ",1,0};

 
    __root const CFG_HDR cfghdrs1_s1={1,"Время подкл./отключ.(сек)",0,1000};
    __root const unsigned int ON_OFF_TIME=10;  
  
  
    __root const CFG_HDR cfghdrHead_1={11,"Статус",0,2};
    __root const int HEAD_STATUS = 1;
  
    __root const CFG_HDR cfghdrHead_2={11,"Х-Статус",0,2};
    __root const int HEAD_XSTATUS = 1;
  
    __root const CFG_HDR cfghdrHead_3={11,"Приват.статус",0,2};
    __root const int HEAD_PRIVATE = 1;
  
    __root const CFG_HDR cfghdrHead_4={5,"Пинг",0,3};
    __root const int HEAD_PING = 1;
    __root const CFG_CBOX_ITEM cfgcboxs15[3]={"Картинка","Текст","Ничего"};
    
    __root const CFG_HDR cfghdrs1_15={11,"Отображать траффик",0,2};
    __root const int ShowTraff = 1;
  
    
    __root const CFG_HDR cfghdrs1_11={11,"Отображать кол-во контактов",0,2};
    __root const int isShowCont = 1;
  
  
    __root const CFG_HDR cfghdrs1_12={11,"Отображать кол-во непрочит.",0,2};
    __root const int isShowUnread = 1;
    
  
    __root const CFG_HDR cfghdrs1_4={11,"Отображать вибру [V] ",0,2};
    __root const int isShowV = 1;
    
    
    __root const CFG_HDR cfghdrs1_5={11,"Отображать звук [S]",0,2};
    __root const int isShowS = 1;
    
    
    __root const CFG_HDR cfghdrs1_6={11,"Отображать автостатус [A]",0,2};
    __root const int isShowA = 1;
  
    
    __root const CFG_HDR cfghdrs1_7={11,"Отображать напоминалку [Vr]",0,2};
    __root const int isShowR = 1;
    
    
    
    __root const CFG_HDR cfghdrs1_9={11,"Отображать заряд батареи",0,2};
    __root const int isShowBat = 0;
   
  
__root const CFG_HDR cfghdr_s0={9,"",0,0};

    
    
  __root const CFG_HDR cfghdrCl_1={9,"Контакт лист",1,0};   

     __root const CFG_HDR cfghdrrCl_2={8,"Цвет фона КЛ",0,0};
     __root const char CLBackgrClr[4]={0x00,0x00,0x00,0x64};
     
     __root const CFG_HDR cfghdrrCl_3={8,"Цвет софтов",0,0};
     __root const char SoftBackgrClr[4]={0xFF,0x48,0x00,0x1B};   
     
     __root const CFG_HDR cfghdrrCl_4={8,"Цвет надписей софтов",0,0};
     __root const char SoftFontClr[4]={0xFF,0xFF,0xFF,0x64};
     
     __root const CFG_HDR cfghdrrCl_5={8,"Цвет заголовка",0,0};
     __root const char HeadBackgrClr[4]={0xFF,0x48,0x00,0x1B};   
     
     __root const CFG_HDR cfghdrrCl_6={8,"Цвет надписей заголовка",0,0};
     __root const char HeadFontClr[4]={0xFF,0xFF,0xFF,0x64};
     
     __root const CFG_HDR cfghdrrCl_7={8,"Цвет скроллбара",0,0};
     __root const char ScrollBarClr[4]={0xFF,0x00,0x00,0x15};
     
     __root const CFG_HDR cfghdrrCl_8={8,"Цвет курсора",0,0};
     __root const char ClCursorClr[4]={0xFF,0x00,0x00,0x32};
     
     __root const CFG_HDR cfghdrrCl_9={8,"Цвет рамки курсора",0,0};
     __root const char ClCursorBordClr[4]={0x00,0x00,0x00,0x60};
     
     __root const CFG_HDR cfghdrrCl_10={8,"Цвет активных",0,0};
     __root const char ActiveClr[4]={0xFF,0xFF,0x00,0x64};
     
     __root const CFG_HDR cfghdrrCl_11={8,"Цвет неактивных",0,0};
     __root const char NotActiveClr[4]={0x00,0xFF,0x00,0x64};
     
     __root const CFG_HDR cfghdrrCl_16={8,"Цвет групп",0,0};
     __root const char GroupClr[4]={0xFF,0x00,0x00,0x64};
     
     __root const CFG_HDR cfghdrrCl_17={8,"Цвет подписей",0,0};
     __root const char CLDescricpClr[4]={0xFF,0x00,0x00,0x64};
     
     __root const CFG_HDR cfghdrrCl_12={8,"Фон доп.инфо",0,0};
     __root const char AddInfoClr[4]={0xFF,0x00,0x00,0x64};
     
     __root const CFG_HDR cfghdrrCl_13={8,"Шрифт доп.инфо",0,0};
     __root const char FontInfoClr[4]={0xFF,0xFF,0xFF,0x64};
     
     __root const CFG_HDR cfghdrrCl_14={8,"Цвет не доставленных",0,0};
     __root const char UnAckedClr[4]={0xFF,0xFF,0x0,0x15};
     
     __root const CFG_HDR cfghdrrCl_15={8,"Цвет отправленных",0,0};
  ...
  __root const CFG_HDR cfghdrCl_0={9,"",0,0};
  
  __root const CFG_HDR cfghdrM_1={9,"Главное меню",1,0};
  
      __root const CFG_HDR cfghdrrM_4={8,"Цвет фона",0,0};
      __root const char MMBackgrClr[4]={0x00,0x00,0x00,0x45};
      
      __root const CFG_HDR cfghdrrM_5={8,"Цвет обводки",0,0};
      __root const char MMBackgrBordClr[4]={0xFF,0xFF,0xFF,0x64};
           
      __root const CFG_HDR cfghdrrM_2={8,"Цвет курсора",0,0};
      __root const char MMCursorBGClr[4]={0x00,0x00,0x00,0x00};
      
      __root const CFG_HDR cfghdrrM_3={8,"Цвет обводки курсора",0,0};
      __root const char MMCursorClr[4]={0xFF,0xFF,0xFF,0x64}; 
      

      __root const CFG_HDR cfghdrM_6 = {14, "Меню", 0, 0};
      __root const RECT MMRect = {0,60,179,303};
      
      __root const CFG_HDR cfghdrM_7 = {14, "Статусы", 0, 0};
      __root const RECT SRect = {30,(24)+2,190,260};
      
      __root const CFG_HDR cfghdrM_8 = {14, "Х-Статусы", 0, 0};
      __root const RECT XSRect = {30,(24)+2,231,300};   
      
       __root const CFG_HDR cfghdrM_9={11,"Показывать цифры",0,2};
       __root const unsigned int ShowNumbMenu = 1;    
   
  __root const CFG_HDR cfghdrM_0={9,"",0,0};
          
  
  
  
    __root const CFG_HDR cfghdr_e1={9,"Пнг шрифт",1,0};
          
          __root const CFG_HDR cfghdr23 = {2, "Путь к 1 png шрифту", 0, 127};
          __root const char fontpath2[128] = "";
          
          __root const CFG_HDR cfghdr24 = {2, "Путь к 2 png шрифту", 0, 127};
          __root const char fontpath3[128] = "";        
          
          __root const CFG_HDR cfghdre1_2 = {2, "png шрифт заголовка", 0, 127};
          __root const char fontpath4[128] = "";
          
          __root const CFG_HDR cfghdr_e1_3={11,"Пнг шрифт заголовка",0,2};
          __root const int PNG_HEADER = 1;
        
          __root const CFG_HDR cfghdr_e1_4={11,"Пнг шрифт софтов",0,2};
          __root const int PNG_SOFTKEY = 1;
    
    __root const CFG_HDR cfghdr_e0={9,"",0,0};
     
     
    __root const CFG_HDR cfghdr_y1={9,"Системный шрифт",1,0};
     
          __root const CFG_HDR cfghdr_2_2={11,"Использовать сист. шрифт",0,2};
          __root const int isSystemFont = 1;
          
          __root const CFG_HDR cfghdr2_8 = {1, "Шрифт", 0, 15};  
          __root const unsigned int pngFont = 8;
          
          __root const CFG_HDR cfghdr2_9 = {1, "Шрифт заголовка", 0, 15};  
          __root const unsigned int HeadFont = 8;
    
    __root const CFG_HDR cfghdr_y0={9,"",0,0};


    

    
    __root const CFG_HDR cfghdr23_4={9,"Клавиши",1,0};    
      ...
      __root const CFG_HDR cfghdr34_642={5,"Вкл. действие на громк.вниз",0,2};
      __root const int isVolDownButton = 1;
      __root const CFG_CBOX_ITEM cfgcbox434_56[2]={"Нет","Да"};
      
      __root const CFG_HDR cfghdr34_6342={5,"Вкл.действие на громк.вверх",0,2};
      __root const int isVolUpButton = 1;
      __root const CFG_CBOX_ITEM cfgcbox4134_56[2]={"Нет","Да"};
      
    
    
      __root const CFG_HDR cfghdr99_1={9,"Длинное нажатие",1,0};
          ...
          __root const CFG_HDR cfghdr23_1={5,"Длинное нажатие + в чате",0,2};
          __root const int LongVolUpAction = 1;
          __root const CFG_CBOX_ITEM cfgcbox23_2[2]={"Обычно","Вставка посл.сообщения"};
        
        
          __root const CFG_HDR cfghdr23_3={5,"Длинное нажатие - в чате",0,2};
          ...
          __root const CFG_HDR cfghdr99_3_0={5,"Длинная 0 в КЛ",0,14};
          __root const int longAct_0 = 10;
          __root const CFG_CBOX_ITEM cfgcbox99_4_0[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_1={5,"Длинная 1 в КЛ",0,14};
          __root const int longAct_1 = 1;
          __root const CFG_CBOX_ITEM cfgcbox99_4_1[14]={"Без действия",
                                                      "Звук",
                                                      "Вибра",
                                                      "Инвиз",
                                                      "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_2={5,"Длинная 2 в КЛ",0,14};
          __root const int longAct_2 = 2;
          __root const CFG_CBOX_ITEM cfgcbox99_4_2[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_3={5,"Длинная 3 в КЛ",0,14};
          __root const int longAct_3 = 3;
          __root const CFG_CBOX_ITEM cfgcbox99_4_3[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_4={5,"Длинная 4 в КЛ",0,14};
          __root const int longAct_4 = 4;
          __root const CFG_CBOX_ITEM cfgcbox99_4_4[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_5={5,"Длинная 5 в КЛ",0,14};
          __root const int longAct_5 = 5;
          __root const CFG_CBOX_ITEM cfgcbox99_4_5[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_6={5,"Длинная 6 в КЛ",0,14};
          __root const int longAct_6 = 6;
          __root const CFG_CBOX_ITEM cfgcbox99_4_6[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_7={5,"Длинная 7 в КЛ",0,14};
          __root const int longAct_7 = 7;
          __root const CFG_CBOX_ITEM cfgcbox99_4_7[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_8={5,"Длинная 8 в КЛ",0,14};
          __root const int longAct_8 = 8;
          __root const CFG_CBOX_ITEM cfgcbox99_4_8[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_9={5,"Длинная 9 в КЛ",0,14};
          __root const int longAct_9 = 9;
          __root const CFG_CBOX_ITEM cfgcbox99_4_9[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_10={5,"Длинная # в КЛ",0,14};
          __root const int longAct_10 = 11;
          __root const CFG_CBOX_ITEM cfgcbox99_4_10[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_11={5,"Длинная * в КЛ",0,14};
          __root const int longAct_11 = 12;
          __root const CFG_CBOX_ITEM cfgcbox99_4_11[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_3_RB={5,"Длинная вправо в КЛ",0,14};
          __root const int longAct_RB = 13;
          __root const CFG_CBOX_ITEM cfgcbox99_4_RB[14]={"Без действия",
                                                        "Звук",
                                                        "Вибра",
                                                        "Инвиз",
                                                        "Реж.напоминания",
          ...
          __root const CFG_HDR cfghdr99_2={9,"",0,0}; 
          
    __root const CFG_HDR cfghdr223_5={9,"",0,0}; 

__root const CFG_HDR cfghdrI_0={9,"",0,0};
...
__root const CFG_HDR cfghdrSnd1={9,"Доп.звуки",1,0};

    __root const CFG_HDR cfghdr181={5,"Extended sounds",0,2};
    __root const unsigned int extended_sounds = 0;
    __root const CFG_CBOX_ITEM cfgcbox18_3_2[2]={"No","Yes"};
    
    __root const CFG_HDR cfghdr1812={5,"Add sound type file",0,3};
    __root const unsigned int ext_type_sounds = 0;
    __root const CFG_CBOX_ITEM cfgcbox182_3_2[3]={"Mp3","Wav","Amr"};
    
    __root const CFG_HDR cfghdr15={2,"add online msg path",0,63};
    __root const char sndGlobal2[64]= "4" ":\\ZBin\\NatICQ\\Sounds\\Uins_on\\";
  
    __root const CFG_HDR cfghdr161={2,"add new msg path",0,63};
    __root const char sndMsg2[64]= "4" ":\\ZBin\\NatICQ\\Sounds\\Uins_msg\\";
    
    __root const CFG_HDR cfghdr16r1={2,"Пинг",0,63};
    __root const char pingsnd[64]= "4" ":\\ZBin\\NatICQ\\Sounds\\sndPing.amr";    
    
    __root const CFG_HDR cfghdr16r2={2,"Обрыв связи",0,63};
    __root const char sndLostConn[64]= "4" ":\\ZBin\\NatICQ\\Sounds\\SndLostConn2.amr";  

__root const CFG_HDR cfghdrSnd0={9,"",0,0};
...
__root const CFG_HDR cfghdr_45={9,"Статусы",1,0};
    ...
    __root const CFG_HDR cfghdr780_1={5,"Индив.настройки хстатуса",0,2};
    __root const int ind_set_xstatus = 0;
    __root const CFG_CBOX_ITEM cfgcbox8_z2[2]={"No","Yes"};
    
    __root const CFG_HDR cfghdr780_11={5,"Мигать при сообщении",0,2};
    ...
    __root const CFG_HDR cfghdr19_242={1,"1я картика хстатуса в иконбаре",0,65535};
    __root const unsigned int NumXStatusToIconBar = 8100;  

    __root const CFG_HDR cfghdr_32_1={9,"Доп. статус в иконбар",1,0};
 
       __root const CFG_HDR cfghdr32_2={1,"UIN",0,0xFFFFFFFF};
       __root const unsigned int ADDITION_UIN=0;
    
       __root const CFG_HDR cfghdr332_3={11,"Показывать при активном",0,2};
       __root const int ShowAddStatusToIconBar = 0;
       
       __root const CFG_HDR cfghdr32_3={11,"Показывать статус",0,2};
       __root const int show_add_state = 0;


       __root const CFG_HDR cfghdr32_5={11,"Показывать хстатус",0,2};
       __root const int show_add_xstate = 0;


   __root const CFG_HDR cfghdr_32_0={9,"",0,0};
...
__root const CFG_HDR cfghdr1_45={9,"Пнг шрифт",1,0};
...
__root const CFG_HDR cfghdr41={9,"Cмайлы",1,0};


  __root const CFG_HDR cfghdrSm_5={5,"Стандартные клавиши",0,2};
  __root const int UseStandartSmileSel = 0;
  __root const CFG_CBOX_ITEM cfgcboxSm_6[2]={"No","Yes"};  
       
  __root const CFG_HDR cfghdr40_1={8,"Цвет фона",0,0};
  __root const char SmBGcolor[4]={0xFF,0xFF,0xFF,100};
  
  __root const CFG_HDR cfghdr40_2={8,"Цвет курсора",0,0};
  __root const char SmSelectColor[4]={0xFF,0x00,0x00,0x2A};
  
  __root const CFG_HDR cfghdr40_3={8,"Цвет текста смайлов",0,0};
  __root const char SmFontColor[4]={0x00,0x00,0x00,100};

__root const CFG_HDR cfghdr40={9,"",0,0};
...
__root const CFG_HDR cfghdr_m71={9,"Главный экран",1,0};

    __root const CFG_HDR cfghdrm71_2 = {5,"Показывать время",0,2};
    ...
    __root const CFG_HDR cfghdr123698 = {5,"Показывать пинг",0,2};
    ...
    __root const CFG_HDR cfghdr1z9a_1={1,"Звук пинга после(сек)",0,50};
...
__root const CFG_HDR cfghdr_m61={9,"Автостатус",1,0};
    ...
    __root const CFG_HDR cfghdr_m61_1 = {5,"Вкл. недоступен",0,2};
    __root const int IsOnNAStatus = 1;
    __root const CFG_CBOX_ITEM cfgcbox_m61_2[2]={"No","Yes"};

    __root const CFG_HDR cfghdr61_8={1,"Время до недоступен(мин)",0,150};
    __root const unsigned int NAStatusTime=20;    
    
    __root const CFG_HDR cfghdr6678 = {5,"Включить автоматически при",0,13};
    ...
    __root const CFG_HDR cfghdr667={1,"Время (мин)",0,500};
    __root const unsigned int AUTO_ENGADE=20;
    
    __root const CFG_HDR cfghdr61_18={1,"Количество ответов",0,150};
    ...
    __root const CFG_HDR cfghdrzz_9={4,"Сообщение отсутствия",0,255};
...
__root const CFG_HDR cfghdra1={9,"Автосмена статусов",1,0};

    __root const CFG_HDR cfghdra1_3={5,"1 cтатус",0,13};
    ...
    __root const CFG_HDR cfghdra1_2={12,"Время смены",0,0};
    __root const TTime tm_status_1={15,0};   
    

    __root const CFG_HDR cfghdra1_1={5,"2 cтатус",0,13};
    ...
    __root const CFG_HDR cfghdra1_4={12,"Время смены",0,0};
    __root const TTime tm_status_2={15,0};


    __root const CFG_HDR cfghdra1_5={5,"3 cтатус",0,13};
    ...
    __root const CFG_HDR cfghdra1_6={12,"Время смены",0,0};
    __root const TTime tm_status_3={15,0};


    __root const CFG_HDR cfghdra1_7={5,"4 cтатус",0,13};
    ...
    __root const CFG_HDR cfghdra1_8={12,"Время смены",0,0};
    __root const TTime tm_status_4={15,0};


    __root const CFG_HDR cfghdra1_9={5,"5 cтатус",0,13};
    ...
    __root const CFG_HDR cfghdra1_14={12,"Время смены",0,0};
    __root const TTime tm_status_5={15,0};


__root const CFG_HDR cfghdra0={9,"",0,0};




__root const CFG_HDR cfghdr_91={9,"Заставка",1,0};

    __root const CFG_HDR cfghdr9_1 = {5,"Включить заставку",0,2};
    __root const int isScreenSaverEna = 0;
    __root const CFG_CBOX_ITEM cfgcbox9_2[2]={"No","Yes"};
    
    __root const CFG_HDR cfghdr9_3={1,"Время до срабатывания(1мин=12)",0,1000};
    __root const unsigned int screenSaverTime=120;

__root const CFG_HDR cfghdr_90={9,"",0,0};





__root const CFG_HDR cfghdr_51={9,"Всплывающие сообщ.",1,0};

    __root const CFG_HDR cfghdr51_0 = {5,"Показывать",0,4};
    __root const int PopupShow = 3;
    __root const CFG_CBOX_ITEM cfgcbox51_2[4]={"Ничего","Вход.сообш.","Подкл.конт.","Все"};
    
    __root const CFG_HDR cfghdr51_1={2,"Формат входящ.сооб.",0,8};
    __root const char PopupMsgString[9]="%s";
    
    __root const CFG_HDR cfghdr51_2={2,"Формат подкл.контакта",0,8};
    __root const char PopupOnlineString[9]=">%s<";  
    
    __root const CFG_HDR cfghdr51_3={1,"Шрифт всплыв.сообщ",0,1000};
    __root const unsigned int PopupFont=8;
    
    __root const CFG_HDR cfghdr51_6={8,"Фон всплыв.сообщ.",0,0};
    __root const char PopupBGCl[4]={0x00,0x00,0x00,100};
    
    __root const CFG_HDR cfghdr51_4={8,"Цвет подкл.контакта",0,0};
    __root const char PopupOnlineCl[4]={0x00,0xFF,0x00,100};
    
    __root const CFG_HDR cfghdr51_5={8,"Цвет входящ.сообщ.",0,0};
    __root const char PopupMsgCl[4]={0xFF,0xFF,0xFF,100};
    
    
    __root const CFG_HDR cfghdr51_9={11,"Показывать отключенных",0,2};
    __root const int isPopupOff = 1;
    
    __root const CFG_HDR cfghdr51_7={8,"Фон отключившихся",0,0};
    __root const char PopupOffBGCl[4]={0x00,0x00,0x00,100};
    
    __root const CFG_HDR cfghdr51_8={8,"Цвет отключившихся",0,0};
    __root const char PopupOffCl[4]={0xFF,0x00,0x00,100};

__root const CFG_HDR cfghdr_50={9,"",0,0};
...
__root const CFG_HDR cfghdr_m51={9,"Экстра опции",1,0};
    ...
    __root const char CsmAdr[9]="A087B454";  
    

    __root const CFG_HDR cfghdr67={4,"Текст для вывода песни",0,31};
    __root const char playing[32]="NatICQ play:";
    

    __root const CFG_HDR cfghdr7820={11,"Отображать Id3 при люб.стат.",0,2};
    __root const int Is_ID3_ANY_STATUS = 1;

    

    __root const CFG_HDR cfghdr780={11,"Отображать запрос команд",0,2};
    __root const int show_send_info = 1;


    
    __root const CFG_HDR cfghdr7_80={11,"Показ. время изм.стат.контакта",0,2};
    __root const int isLogStatusChange = 1;

    

    __root const CFG_HDR cfghdr71_30={11,"Показывать Loopback в КЛ",0,2};
    __root const int IsShowLoopback = 1;

    
     
    __root const CFG_HDR cfghdr71_31={11,"Открывать ссылки",0,2};
    __root const int IsOpenBrowser = 0;

    
    __root const CFG_HDR cfghdr71_33={11,"Мульти буффер",0,2};
...
__root const CFG_HDR cfghdr_q1={9,"Экран заргузки",1,0};

   __root const CFG_HDR cfghdr_s2 = {14, "Прогрессбар", 0, 0};
   __root const RECT PBRECT = {1,280,238,287};
   
  __root const CFG_HDR cfghdr_s3={8,"Цвет прогрессбара",0,0};
  __root const char PBcolor[4]={0xFF,0x00,0x00,0x20};
  
  __root const CFG_HDR cfghdr_s7={8,"Фон прогрессбара",0,0};
  __root const char BGPBcolor[4]={0xFF,0xFF,0xFF,0x00};

  __root const CFG_HDR cfghdr_s4={5,"Менять софты",0,2};
  __root const int IsInvertSoftKey = 1;
  __root const CFG_CBOX_ITEM cfgcbox_s5[2]={"No","Yes"};  

  __root const CFG_HDR cfghdr_s6={5,"Показывать инфу",0,2};
  __root const int IsShowInfo = 1;
  __root const CFG_CBOX_ITEM cfgcbox_s7[2]={"No","Yes"};    

__root const CFG_HDR cfghdr_q0={9,"",0,0};


__root const CFG_HDR cfghdrL_1={9,"Лог",1,0};

    __root const CFG_HDR cfghdrL_2={11,"Вести лог",0,2};
    __root const int IsLogEna = 1;

    __root const CFG_HDR cfghdrL_5={1,"Шрифт",0,10};
    __root const unsigned int _fontlog=8;    
    
    __root const CFG_HDR cfghdrL_3={8,"Фон",0,0};
    __root const char BGLog[4]={0x00,0x00,0x00,0x64};
    
    __root const CFG_HDR cfghdrL_4={8,"Шрифт",0,0};
    __root const char FontClrLog[4]={0xFF,0xFF,0xFF,0x64};

__root const CFG_HDR cfghdL_0={9,"",0,0};


__root const CFG_HDR cfghdrIn_1={9,"Информация",1,0};

    __root const CFG_HDR cfghdrIn_2={8,"Фон",0,0};
    __root const char BGInfo[4]={0x00,0x00,0x00,0x45};
    
    __root const CFG_HDR cfghdrIn_3={8,"Шрифт",0,0};
    __root const char FontClrInfo[4]={0x00,0xFF,0x00,0x64};

__root const CFG_HDR cfghdrIn_0={9,"",0,0};


__root const CFG_HDR cfghdr11_10={4,"Мое имя",0,31};
__root const char I_str[32]="pashka";

__root const CFG_HDR cfghdr11_9={2,"Небольшой игнор лист",0,255};
