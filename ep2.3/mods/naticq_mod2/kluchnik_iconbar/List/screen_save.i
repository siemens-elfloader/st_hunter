...
void Draw2()
{
  ...
  DrawString(ws,ScreenW()-Get_WS_width(ws,11)-2,igrek,ScreenW()-1,igrek+GetFontYSIZE(11),
                11,4,FontClrInfo,GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void Draw3()
{
  ...
  DrawString(ws,ScreenW()-Get_WS_width(ws,11)-2,igrek,ScreenW()-1,igrek+GetFontYSIZE(11),
             11,0,FontClrInfo,GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void reftes()
{
  ...
  DrawRectangle(0,(24),scr_w,scr_h,0,BGInfo,BGInfo); 
  char *sws=malloc(64);
  *(sws)=0;
  ...
  wsprintf(ws,"%s",sws);
  DrawString(ws,2,ScreenH()-GetFontYSIZE(11)-4,ScreenW(),ScreenH(),11,2,FontClrInfo,GetPaletteAdrByColorIndex(23));
  ...
  DrawString(ws,2,y,ScreenW()-1,y+(GetFontYSIZE(11)*3),11,0,FontClrInfo,GetPaletteAdrByColorIndex(23));
  if(connect_state==3)   
    y+=(GetFontYSIZE(11)*3);
  else
    y+=(GetFontYSIZE(11)*1);
  ...
  DrawString(ws,2,y,ScreenW()-1,y+(GetFontYSIZE(11)*2),11,0,FontClrInfo,GetPaletteAdrByColorIndex(23));
  y+=(GetFontYSIZE(11)*2);
   
  wsprintf(ws,"Not action %d sec",msg_away_timer*5);
  DrawString(ws,2,y,ScreenW()-1,y+GetFontYSIZE(11),11,0,FontClrInfo,GetPaletteAdrByColorIndex(23));
  y+=(GetFontYSIZE(11)*1);
  ...
  DrawString(ws,2,y,ScreenW()-1,y+(GetFontYSIZE(11)*5),11,0,FontClrInfo,GetPaletteAdrByColorIndex(23));
