...
{
  {S_ICONS+ICON_ALL_CAN_SEE,         (int)"Видимый для всех",           0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_VISLIST_CAN_SEE,     (int)"Видимый только для списка видящих",       0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_INVISLIST_CANNOT_SEE,(int)"Видимый для всех, кроме списка невидящих",  0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_CONTACTLIST_CAN_SEE, (int)"Видимый только для списка контактов",   0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_NOBODY_CAN_SEE,      (int)"Невидимый для всех",        0x7FFFFFFF,0,0,3,0x5A2}
};
...
{
  {0,(int)"Добавить контакт",      0x7FFFFFFF,0,0,3,0x5A2},
  {0,(int)"Приватный статус",  0x7FFFFFFF,0,0,3,0x5A2},
};
