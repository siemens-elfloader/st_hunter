...
#define LG_COPYRIGHT     "(C) by Rst7/CBSIE\nKren,Kibab,Shadow,Seklth" //NATICQ v2.0\nRevision %d\n
...
#define LG_ID3TAG         "Режим Id3tag"
#define LG_INCMSG         "Всплывающие собщения"
#define LG_MNUSLION       "Режим SLI"
#define LG_REMINDERON     "Режим напоминания"
#define LG_MNUPINGON      "Автоматический пинг"
#define LG_MNUSMARTCPU    "Сообщения на гэ"
#define LG_MSGINFO        "Инфо о сообщениях"
#define LG_MNUUPTIMEON    "Время работы"
#define LG_AUTOANSWER     "Автоответчик"
#define LG_MNUILUON       "Режим подсветки"
#define LG_MNUEDCFG_MOD   "Настройки мода"
#define LG_MNUQUOTE2      "Цитир.без фокуса на ответ"
#define LG_SAVECL         "Сохранить КЛ"
...
#define LG_SHOW_XSTATE_TIME "Показ.хстат/время"
#define LG_CONFIG           "Конфиг"
#define LG_CONFIG_MOD       "Конфиг мода"
#define LG_PING             "Пинг"
#define LG_HIHE_LOCK        "Заблокировать"
#define LG_IDLE             "На гэ"
#define LG_USERMENU         "Меню юзера" 
#define LG_ACTUP            "Активные вверху"
