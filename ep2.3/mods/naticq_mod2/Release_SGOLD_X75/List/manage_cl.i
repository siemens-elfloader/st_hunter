...
HEADER_DESC acgd_hdr={0,0,0,0,0,(int)"Добавление контакта",0x7FFF};
...
{
  {S_ICONS+ICON_ALL_CAN_SEE,         (int)"Видимый для всех",           0x7FFF,0,0,3,0x578},
  {S_ICONS+ICON_VISLIST_CAN_SEE,     (int)"Видимый только для списка видящих",       0x7FFF,0,0,3,0x578},
  {S_ICONS+ICON_INVISLIST_CANNOT_SEE,(int)"Видимый для всех, кроме списка невидящих",  0x7FFF,0,0,3,0x578},
  {S_ICONS+ICON_CONTACTLIST_CAN_SEE, (int)"Видимый только для списка контактов",   0x7FFF,0,0,3,0x578},
  {S_ICONS+ICON_NOBODY_CAN_SEE,      (int)"Невидимый для всех",        0x7FFF,0,0,3,0x578}
};
...
static const HEADER_DESC private_list_HDR={0,0,0,0,0,(int)"Приватный статус",0x7FFF};
...
{
  {0,(int)"Добавить контакт",      0x7FFF,0,0,3,0x578},
  {0,(int)"Приватный статус",  0x7FFF,0,0,3,0x578},
};
...
static const HEADER_DESC mmanage_cl_HDR={0,0,0,0,0,(int)"Управление списком",0x7FFF};
