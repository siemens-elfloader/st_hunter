...
__root const CFG_HDR cfghdr31={9,"Оригинальные настройки",1,0};
  ...
  __root const CFG_CBOX_ITEM cfgcbox15_1[2]={"Use set orig.config", "After unlock"};
    ...
    __root const CFG_HDR cfghdr6_8={5,"Show Active contact",0,2};
...
__root const CFG_HDR cfghdrI_1={9,"Интерфейс",1,0};
  ...
  __root const unsigned int ShowStatusToIconBar = 0;    
  
  __root const CFG_HDR cfghdrI_6={11,"Пинг в иконбаре",0,2};
  __root const unsigned int PingToIconBar = 0;    
  
  __root const CFG_HDR cfghdrI_8={11,"Показывать отправку",0,2};
...
__root const CFG_HDR cfghdr_q1={9,"Экран заргузки",1,0};
   ...
   __root const RECT PBRECT = {4,280,231,287};
