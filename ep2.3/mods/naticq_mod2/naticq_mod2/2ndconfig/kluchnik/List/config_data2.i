...
__root const CFG_HDR cfghdr31={9,"Оригинальные настройки",1,0};
  ...
  __root const CFG_CBOX_ITEM cfgcbox15_1[2]={"Use set orig.config", "After unlock"};
    ...
    __root const CFG_HDR cfghdr6_7={5,"History read buffer",0,2};
    ...
    __root const CFG_HDR cfghdr16r1={2,"ping sound",0,63};
    __root const char pingsnd[64]= "4" ":\\ZBin\\NatICQ\\Sounds\\sndPing.wav";
...
__root const CFG_HDR cfghdr_45={9,"Настройка статусов",1,0};
    ...
    __root const CFG_HDR cfghdr_32_1={9,"Доп. статус в иконбар",1,0};
       ...
       __root const CFG_HDR cfghdr32_3={5,"Показывать статус",0,2};
       __root const int show_add_state = 0;
       __root const CFG_CBOX_ITEM cfgcbox32_4[2]={"No","Yes"};       

       __root const CFG_HDR cfghdr32_5={5,"Показывать хстатус",0,2};
...
__root const CFG_HDR cfghdr41={9,"Цвета выбора смайлов",1,0};
...
__root const CFG_HDR cfghdr_m71={9,"Настройка ГЭ",1,0};
...
__root const CFG_HDR cfghdr_s1={9,"Настройка заголовка КЛ",1,0};


    __root const CFG_HDR cfghdrs1_1 = {5,"Показывать в заголовке с КЛ",0,6};
...
__root const CFG_HDR cfghdr_m51={9,"Экстра опции",1,0};
    ...
    __root const CFG_HDR cfghdr7_80={5,"Показ. время изм.стат.контакта",0,2};
    ...
    __root const CFG_HDR cfghdr71_31={5,"Открывать ссылки",0,2};
    __root const int IsOpenBrowser = 0;
    __root const CFG_CBOX_ITEM cfgcbox_32[2]={"No","Yes"};   
    
    __root const CFG_HDR cfghdr71_33={5,"Мульти буффер",0,2};
...
__root const CFG_HDR cfghdr11_10={2,"Мое имя",0,31};
