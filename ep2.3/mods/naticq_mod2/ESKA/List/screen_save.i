...
void Draw()
{
  ...
  DrawString(ws,iks-10,igrek-40,iks-10+Get_WS_width(ws,5)+2,igrek-40+GetFontYSIZE(5),11,0,GetPaletteAdrByColorIndex(5),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void Draw2()
{
  ...
  DrawString(ws,ScreenW()-Get_WS_width(ws,14)-2,igrek,ScreenW()-1,igrek+GetFontYSIZE(14),
                14,4,FontClrInfo,GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void Draw3()
{
  ...
  DrawString(ws,ScreenW()-Get_WS_width(ws,14)-2,igrek,ScreenW()-1,igrek+GetFontYSIZE(14),
             14,0,FontClrInfo,GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void Draw5()
{
  ...
  DrawString(ws,0,(0)+15,ScreenW()-1,40+GetFontYSIZE(14),14,2,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void reftes()
{
  ...
  DrawRectangle(0,(0),scr_w,scr_h,0,BGInfo,BGInfo); 
  char *sws=malloc(64);
  *(sws)=0;
  ...
  wsprintf(ws,"%s",sws);
  DrawString(ws,2,ScreenH()-GetFontYSIZE(14)-4,ScreenW(),ScreenH(),14,2,FontClrInfo,GetPaletteAdrByColorIndex(23));
  ...
  DrawString(ws,2,y,ScreenW()-1,y+(GetFontYSIZE(14)*3),14,0,FontClrInfo,GetPaletteAdrByColorIndex(23));
  if(connect_state==3)   
    y+=(GetFontYSIZE(14)*3);
  else
    y+=(GetFontYSIZE(14)*1);
  ...
  DrawString(ws,2,y,ScreenW()-1,y+(GetFontYSIZE(14)*2),14,0,FontClrInfo,GetPaletteAdrByColorIndex(23));
  y+=(GetFontYSIZE(14)*2);
   
  wsprintf(ws,"Not action %d sec",msg_away_timer*5);
  DrawString(ws,2,y,ScreenW()-1,y+GetFontYSIZE(14),14,0,FontClrInfo,GetPaletteAdrByColorIndex(23));
  y+=(GetFontYSIZE(14)*1);
  ...
  DrawString(ws,2,y,ScreenW()-1,y+(GetFontYSIZE(14)*5),14,0,FontClrInfo,GetPaletteAdrByColorIndex(23));
