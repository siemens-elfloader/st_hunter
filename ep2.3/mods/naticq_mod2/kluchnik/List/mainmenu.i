...
static void ChangeActiveUp(void)
{
...
static const void *menuprocs[25]=
{
  (void *)CreateSCMenu,
  (void *)CreateXSMenu,
 ...
 switch(curitem)
  {
    ...
    case 7: DrawCheckBox(x,y,Is_SMARTCPU_On?1:0,0);           break;
    case 8: DrawCheckBox(x,y,Is_Double_Vibra_On?1:0,0);       break;
    case 9: DrawCheckBox(x,y,Is_ILU_On?1:0,0);                break;
    case 10: DrawCheckBox(x,y,Is_PING_On?1:0,0);              break;
    case 11: DrawCheckBox(x,y,Is_UPTIME_On?1:0,0);            break;  
    case 12: DrawCheckBox(x,y,Is_Show_Offline?1:0,0);         break;
    case 13: DrawCheckBox(x,y,Is_Show_Groups?1:0,0);          break;    
    ...
    case 21: DrawCheckBox(x,y,IsActiveUp?1:0,0);              break;
    case 22: DrwImage(icons[ICON_SETTINGS],x,y,0,0);          break;
    case 23: DrawCheckBox(x,y,Is_Id3tag_Enabled?1:0,0);       break;
    case 24: DrawCheckBox(x,y,Is_SLI_On?1:0,0);               break;
  }
}
...
static void MM_DrawList()
{
  ...
  int scr_h=ScreenH()-1;
  int scr_w=ScreenW()-1;
  mm_itemFromDisp = sdiv(font_y,scr_h-((24)+2)-FontH(mm_font)-2)-1;
   ...
   if(startItem+i==mm_curpos)
    {
     ...
     DrawMMScrollBar(startItem+i,25);
    } 
   DrawIcon(1,start_y,startItem+i);
   PrintText(rc.x+3,rc.y-1,s,0,mm_font,1,0,0,0,rc.x2-5);
   i++;
   if(startItem+i >= 25) break;
  }
  mfree(s);
  UnlockSched();  
}
...
void MM_MoveDown(int i)
{
  if(mm_curpos <mm_itemFromDisp - 5) mm_curpos++;
    ...
    if(mm_curpos < 25 - 1 ){if(startItem < 25-mm_itemFromDisp) startItem++; mm_curpos++; }
  else   
  {
    mm_curpos=0;
    startItem=0;
...
static void MM_onCreate(MAIN_GUI *data, void *(*malloc_adr)(int))
{
  ...
  if(!one_use)
  {
    ...
    PrintField(0,(24),menutexts[6],0,mm_font,1);
    int len=GetWidth(0,(24));
    mm_rc.x2=ScreenW()-(len/4);
...
static int MM_OnKey(MAIN_GUI *data, GUI_MSG *msg)
{
  ...
  if (msg->gbsmsg->msg==0x193)
  {
    ...
    if(k>='0' && k<= '9'){ ((void (*)(void))(menuprocs[k-'1']))(); mm_curpos=k-'1'; REDRAW();}
  }   
