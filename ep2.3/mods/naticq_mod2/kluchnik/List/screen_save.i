...
void Draw()
{
  ...
  DrawString(ws,iks-10,igrek-40,iks-10+Get_WS_width(ws,5)+2,igrek-40+GetFontYSIZE(5),8,0,GetPaletteAdrByColorIndex(5),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void Draw2()
{
  ...
  DrawString(ws,ScreenW()-Get_WS_width(ws,11)-2,igrek,ScreenW()-1,igrek+GetFontYSIZE(11),
                11,4,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void Draw3()
{
  ...
  DrawString(ws,ScreenW()-Get_WS_width(ws,11)-2,igrek,ScreenW()-1,igrek+GetFontYSIZE(11),
             11,0,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void Draw5()
{
  ...
  DrawString(ws,0,(24)+15,ScreenW()-1,40+GetFontYSIZE(11),11,2,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
extern int connect_state;
extern volatile unsigned long ALLTOTALRECEIVED;	
...
void reftes()
{
  ...
  DrawRectangle(0,(24),scr_w,scr_h,0,black,black); 
  char *sws=malloc(64);
  *(sws)=0;
  ...
  wsprintf(ws,"%s",sws);
  DrawString(ws,2,ScreenH()-GetFontYSIZE(11)-4,ScreenW(),ScreenH(),11,2,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
  ...
  DrawString(ws,2,y,ScreenW()-1,y+(GetFontYSIZE(11)*3),11,0,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
  if(connect_state==3)   
    y+=(GetFontYSIZE(11)*3);
  else
    y+=(GetFontYSIZE(11)*1);
  ...
  DrawString(ws,2,y,ScreenW()-1,y+(GetFontYSIZE(11)*2),11,0,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
  y+=(GetFontYSIZE(11)*2);
   
  wsprintf(ws,"Not action %d sec",msg_away_timer*5);
  DrawString(ws,2,y,ScreenW()-1,y+GetFontYSIZE(11),11,0,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
  y+=(GetFontYSIZE(11)*1);
  
  unsigned long RX=ALLTOTALRECEIVED;
  unsigned long TX=ALLTOTALSENDED;

  wsprintf(ws, "Traffic:\n->Rx: %db\n->Tx: %db \n->Queue: %db \n"
               "Online contact: %d [total: %d] \n",RX,TX,sendq_l,kopa_kontaktu, kopa_online);
  DrawString(ws,2,y,ScreenW()-1,y+(GetFontYSIZE(11)*5),11,0,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
...
static void method1(SCREEN_GUI *data,void *(*malloc_adr)(int))
{
  data->ws=AllocWS(50);
  data->gui.state=1;
  DrawRectangle(0,(24),ScreenW()-1,ScreenH()-1,0,black,black); 
  color_SS=0;
  reftes();
}
...
static void method3(SCREEN_GUI *data,void *(*malloc_adr)(int),void (*mfree_adr)(void *))
{
  saver_on=1;
  DisableIDLETMR();
  data->gui.state=2;
...
static void method4(SCREEN_GUI *data,void (*mfree_adr)(void *))
{
  saver_on=0;
  if (data->gui.state!=2)
    return;
