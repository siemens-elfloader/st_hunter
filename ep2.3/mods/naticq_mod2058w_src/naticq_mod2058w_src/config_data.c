...
//Show status on iconbar or mainscreen
    __root const CFG_HDR cfghdr467_1 = {CFG_CBOX,"Show status icon",0,5};
...
__root const CFG_HDR cfghdr_4={CFG_LEVEL,"",0,0};
  
  
//------------------------------------- FONT SETTING -------------------------------------//   
  
  
__root const CFG_HDR cfghdr1_45={CFG_LEVEL,"Font setting",1,0};
...
__root const CFG_HDR cfghdrss_45={CFG_LEVEL,"",0,0};
...
//Show contact header with...
    __root const CFG_HDR cfghdr467 = {CFG_CBOX,"Show with contacts",0,4};
    __root const int TIME_OR_MSG = 3;
    __root const CFG_CBOX_ITEM cfgcbox91[4]={"Time","Msg","Contacts","All"};
...
//Show time offline contact
    __root const CFG_HDR cfghdr7_80={CFG_CBOX,"Log offline time",0,2};
    __root const int isLogOffline = 0;
    __root const CFG_CBOX_ITEM cfgcbox8df_z[2]={"No","Yes"};
    
//Show time onlain contact
    __root const CFG_HDR cfghdr7_81={CFG_CBOX,"Log online time",0,2};
    __root const int isLogOnline = 0;
    __root const CFG_CBOX_ITEM cfgcbox9df_z[2]={"No","Yes"};
#endif
