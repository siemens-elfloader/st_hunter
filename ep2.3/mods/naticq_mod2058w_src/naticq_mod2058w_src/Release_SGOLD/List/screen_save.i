...
void Draw5()
{
  ...
  DrawString(ws,0,(0)+15,ScreenW()-1 ,40+GetFontYSIZE(11),11,2,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void reftes()
{
  ...
  DrawRectangle(0,0,scr_w,scr_h+(0),0,GetPaletteAdrByColorIndex(color_SS),GetPaletteAdrByColorIndex(color_SS)); 
