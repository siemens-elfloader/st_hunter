...
__root const CFG_HDR cfghdr2={CFG_LEVEL,"Hosts and paths",1,0};
  ...
  __root const char NATICQ_HOST[128]="cbsie.dyndns.info; freegw.alltime.ru; opera.myftp.org; 82.207.89.182; 212.17.23.124; 77.105.136.115; 91.124.140.98";
  ...
  __root const char HIST_PATH[64]=DEFAULT_DISK ":\\ZBin\\Logging\\NatICQ_history";
  ...
  __root const char SMILE_PATH[64]="2:\\NatICQ\\smiles";

  __root const CFG_HDR cfghdr2_6={CFG_STR_UTF8,"Images .png path",0,63};
  __root const char ICON_PATH[64]="2:\\NatICQ\\img";

  __root const CFG_HDR cfghdr2_7={CFG_STR_UTF8,"X-status .png path",0,63};
  __root const char XSTATUSES_PATH[64]="2:\\NatICQ\\ximg";
...
//Status icon on mainscreen position
  ...
  __root const unsigned int IDLEICON_X=98;
  __root const unsigned int IDLEICON_Y=82;
  
  __root const CFG_HDR cfghdrz68 = {CFG_CBOX,"X-status idle",0,2};
  ...
  __root const unsigned int IDLEICON_XX=115;
  __root const unsigned int IDLEICON_YX=81;
  
  __root const CFG_HDR cfghdr19_1={CFG_UINT,"Smile back color",0,23};
  __root const unsigned int color_choose = 21;
  
  __root const CFG_HDR cfghdr19_2={CFG_UINT,"SS back color",0,23};
  __root const unsigned int color_SS = 1; //cvet SS (w)

  __root const CFG_HDR cfghdr65={CFG_UINT,"Vibra count in Vibra rem.",0,10};
  __root const unsigned int Vibra_cc=1;
  ...
  __root const char fontpath[64]="2:\\fonts\\ttf\\6_verdana_black\\"; /*zbin\\img\\font\\*/
...
//First letter when typing
  ...
  __root const CFG_HDR cfghdr4_5={CFG_LEVEL,"Font and colors",1,0};
    ...
    __root const unsigned int TO_COLOR=8;
...
__root const unsigned int date_X = 98;
__root const unsigned int date_Y = 72;
...
__root const int TIME_OR_MSG = 0;
...
__root const CFG_HDR cfghdr8={CFG_LEVEL,"Notify power",1,0};
  ...
  __root const CFG_HDR cfghdr8_5={CFG_LEVEL,"Sounds setup",1,0};
    ...
    __root const unsigned int extended_sounds = 1;
...
__root const char mod_info[264]="Mod by EvilFox, 1st; based on rev.2058, mod date: 25.03.08 for S75 only. Windes: !new bcfg!, recountmenu, critical connect fixes! http://windes.narod.ru/files/naticq_mod2058w.zip (40kb) files: http://windes.narod.ru/files/naticqmod_allfiles_w.zip (432kb)";
