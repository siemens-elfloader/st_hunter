...
#define LG_INCMSG     "Попап ника"
#define LG_MNUSLION   "Режим SLI"
#define LG_REMINDERON "Режим допвибры"
#define LG_MNUPINGON  "Авто пинг"
#define LG_MNUSMARTCPU "Сообщения на ГЭ"
#define LG_MSGINFO   "Инфо сообщений"
#define LG_MNUUPTIMEON "Время онлайн"
#define LG_MNUILUON   "Режим света"
#define LG_MNUSHOWOFF "Оффлайн контакты"
#define LG_MNUSHOWGROUP "Группы"
#define LG_MNUEDCFG   "Настройки"
#define LG_MNUDISCONNECT "Оборвать связь"
#define LG_MNUPING    "Пинг связи"
...
#define LG_MNUADDREN   "Добавить/имя"
...
#define LG_MNUILUON   "Ilum. mode"
#define LG_MNUPINGON  "Auto Ping Mode"
#define LG_MNUUPTIMEON "Show Online time"
