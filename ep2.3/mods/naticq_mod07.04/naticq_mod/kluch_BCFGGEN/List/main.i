...
extern const unsigned int color_choose;
...
void UpdateConfig()
{
  ...
  myConfigMod* myConfMod = (myConfigMod*)malloc(myConfigSize);
...
{
  comanda=1;
  sprintf(mod_info,"mod by Evilfox,kluchnik,windes based on revision 2058, mod date: %s at %s ","Mar 31 2008","11:28:35");
  ...
  if(!strcmp(txt, "GET_URL_INFO"))
  {
    ...
    sprintf(send_txt,"revision 2058, mod date: %s at %s ",
                     ...
                     "Так же все будет тут http://kluchnik.jino-net.ru/naticqmod/","Mar 31 2008","11:28:35");
