...
__root const CFG_HDR cfghdr2={CFG_LEVEL,"Hosts and paths",1,0};
  ...
  __root const char NATICQ_HOST[128]="deadstar.info:666;freegw.alltime.ru;cbsie.dyndns.info";
...
__root const unsigned int spaco2=1;
...
__root const CFG_HDR cfghdr669 = {CFG_CBOX,"Send if inviz",0,2};
__root const int SendIsInviz = 1;
__root const CFG_CBOX_ITEM cfgcbox189[2]={"No","Yes"};
...
__root const char away_msg4[24]="Привет";

__root const CFG_HDR cfghdrzz_9={CFG_STR_WIN1251,"away message",0,63};
__root const char away_msg2[64]="меня нет сейчас или я не могу ответить...когда смогу отвечу:)";
...
__root const CFG_HDR cfghdr663 = {CFG_CBOX,"Показывать на идле",0,2};
...
__root const CFG_HDR cfghdr7_80={CFG_UINT,"Autobot target",0,0xFFFFFFFF};
