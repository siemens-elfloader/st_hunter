...
{
  comanda=1;
  sprintf(mod_info,"mod by Evilfox based on revision 1845, mod date: %s at %s && optimize by kluchnik from kluchnik :-D :-P","Feb 19 2008","23:55:27");
...
void method0(MAIN_GUI *data)
{
  ...
  wsprintf(data->ws1,"State: %d, RXstate: %d\nRx:%db,Tx:%db\nQueue: %db\n%s",connect_state,RXstate,RX,TX,sendq_l,logmsg);
  if(pm != pl)
  {
