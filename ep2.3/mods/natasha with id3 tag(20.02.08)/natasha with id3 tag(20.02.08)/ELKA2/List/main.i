...
const char ipc_my_name[32]= "NatICQ2";
...
{
  comanda=1;
  sprintf(mod_info,"mod by Evilfox based on revision 1845, mod date: %s at %s && optimize by kluchnik from kluchnik :-D :-P","Mar 14 2008","10:13:01");
