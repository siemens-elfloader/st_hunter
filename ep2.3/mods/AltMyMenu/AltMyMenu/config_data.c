...
#ifdef me
__root const CFG_HDR cfghdr_0={CFG_UINT,"Hotkey 2 (dec)",0,99};
__root const int ACTIVE_KEY_2=11;
#endif
...
#ifdef me
__root const CFG_HDR cfghdr1_23={CFG_CBOX,"Key mode 2",0,3};
__root const int ACTIVE_KEY_STYLE_2=0;
__root const CFG_CBOX_ITEM cfgcbox2_3[3]={"Short Press","Long Press","*+#"};
#endif
...
#ifdef me
__root const CFG_HDR cfghdr1_2_33={CFG_CBOX,"Only idle",0,2};
__root const int IDLE_MODE_2=0;
__root const CFG_CBOX_ITEM cfgcbox2453[2]={"No","Yes"};
#endif
