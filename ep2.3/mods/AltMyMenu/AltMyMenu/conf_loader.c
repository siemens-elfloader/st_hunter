...
{
#ifdef me
  if (LoadConfigData("4:\\ZBin\\etc\\AltMyMenu_me.bcfg")<0)
  {
    LoadConfigData("0:\\ZBin\\etc\\AltMyMenu_me.bcfg");
  }
#else
  if (LoadConfigData("4:\\ZBin\\etc\\AltMyMenu.bcfg")<0)
  {
    LoadConfigData("0:\\ZBin\\etc\\AltMyMenu.bcfg");
  }
#endif
}
