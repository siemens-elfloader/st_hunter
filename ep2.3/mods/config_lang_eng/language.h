...
#define LG_ALREADY_STARTED "Aplikбcia je uћ spustenб!"
...
#define LG_GROUPNOTINLIST "Nie sъ v zozname"
//===============================

#define LG_MENU    "Menu"
#define LG_OPTIONS "Voѕby"
#define LG_CLOSE   "Zavrieќ"
#define LG_CLEAR   "<C"
#define LG_DOIT    "Uloћiќ"
#define LG_PASTESM "Vloћiќ"
//-------------
#define LG_SELECT  "Vybraќ"
#define	LG_TEXT    "Text"
#define LG_BACK    "Spдќ"
//--------------
#define LG_ADD      "Pridaќ"
#define LG_ADDCNT   "Pridaќ kontakt"
#define LG_ENTERUIN "Zadajte UIN:"
//--------------
#define LG_ADDREN  "Pridaќ/Premenovaќ"
#define LG_SETNICK "Nastaviќ nick %u ako:" //Какого-то эти строки будучи написаны
#define LG_SMLDESC "Smile: %u %s"           //на русском отображаются крякозябликами
#define LG_ADDSMIL "Vloћiќ smajlнka"

//===============================

#define LG_ADDCONT "Pridaќ kontakt..."
#define LG_AUTHREQ   "Prosнm, autorizuj ma..."
#define LG_AUTHGRANT "Si autorizovanэ"

//================================
#define LG_MNUSTATUS  "Status"
#define LG_MNUXSTATUS "X-Status"
#define LG_MNUADDCONT "Pridaќ kontakt"
#define LG_MNUVIBRA   "Reћim vibrбciн"
#define LG_MNUSOUND   "Reћim zvuku"
#define LG_MNUSHOWOFF "Zobraziќ offline"
#define LG_MNUSHOWGROUP "Skupiny"
#define LG_MNUEDCFG   "Nastavenia"
#define LG_MNUDISCONNECT "Odpojiќ"
#define LG_MNUPING    "Ping"
#define LG_MNUABOUT   "O Elfe..."
//--------------
#define LG_MNUQUOTE    "Citovaќ"
#define LG_MNUADDSML   "Vloћiќ smajlнka"
#define LG_MNUSHINFO   "Info o kontakte"
#define LG_MNUADDREN   "Pridaќ/Premenovaќ"
#define LG_MNUSAUTHREQ "Autoriz. poћiadavok"
#define LG_MNUSAUTHGRT "Autorizovaќ"
#define LG_MNUOPENLOG  "Otvoriќ histуriu"
#define LG_MNUCLEARCHT "Vyиistiќ chat"

#define LG_MNUEDNEXTACT "Пalљie okno"
#define LG_MNUEDPREVACT "Predoљlй okno"

//================================
#define LG_CHGSTATUS "Zmeniќ Status"
#define LG_CHGXSTATUS "Zmeniќ X-Status"

#define LG_STONLINE "Online"
#define LG_STAWAY   "Preи"
#define LG_STNA     "Nedostupnэ"
#define LG_STDND    "Neruљiќ"
#define LG_STOCCUP  "Nemбm иas"
#define LG_STFFC    "Mбm voѕno"
#define LG_STINVIS  "Nevidiќeѕnэ"
#define LG_STDEPRESSION "Smutnэ"
#define LG_STEVIL "Nemбm nбladu"
#define LG_STHOME "Doma"
#define LG_STLUNCH "Jem"
#define LG_STWORK "V prбci"

//================================

#define LG_ALL_CAN_SEE          "Viditeѕnэ pre vљetkэch"
#define LG_VISLIST_CAN_SEE      "Viditeѕnэ pre zoznam 'Viditeѕnэ'"
#define LG_INVISLIST_CANNOT_SEE "Viditeѕnэ pre vљetkэch mimo zoznamu 'Neviditeѕnэ'"
#define LG_CONTACTLIST_CAN_SEE  "Viditeѕnэ iba pre mфj zoznam kontaktov"
#define LG_NOBODY_CAN_SEE       "Neviditeѕnэ pre vљetkэch"

#define LG_ENTERNAME      "Vloћ meno"
#define LG_CHOOSEGROUP    "Vyber skupinu"
#define LG_PRIVSTATUS     "Privбtny status"
#define LG_MANAGELIST     "Sprбva zoznamu"
...
#define LG_MSGVIBRADIS    "Vibrбcie vypnutй!"
#define LG_MSGVIBRAENA    "Vibrбcie zapnutй!"
#define LG_MSGSNDDIS      "Zvuky vypnutй!"
#define LG_MSGSNDENA      "Zvuky zapnutй!"
#define LG_MSGNOUINPASS   "Prosнm, nastavte UIN/Heslo!"
#define LG_MSGSMILNOTFND  "Smajlнky nenбjdenй!"

//-------------------------------- MODS LANGUAGES -------------------------------//

#define LG_ID3TAG         "Reћim Id3tag"
#define LG_INCMSG         "Popup sender"
#define LG_MNUSLION       "Reћim SLI"
#define LG_REMINDERON     "Reћim vibra prip."
#define LG_MNUPINGON      "Auto Ping"
#define LG_MNUSMARTCPU    "Reћim Main msg."
#define LG_MSGINFO        "MSG Info"
#define LG_MNUUPTIMEON    "Online time"
#define LG_AUTOANSWER     "Reћim Auto odp."
#define LG_MNUILUON       "Reћim osvetlenia"
#define LG_MNUEDCFG_MOD   "Nastavenia mуdu"
#define LG_MNUQUOTE2      "Citovaќ... ..."
#define LG_SAVECL         "Uloћiќ CL"
/*#define LG_INCMSG         "Popup sender"
#define LG_MNUSLION       "Режим SLI"
#define LG_REMINDERON     "Режим Vibra rem."
#define LG_MNUPINGON      "Auto Ping"
#define LG_MNUSMARTCPU    "Main msg. mode"
#define LG_MSGINFO        "MSG Info"
#define LG_MNUUPTIMEON    "Online time"
#define LG_AUTOANSWER     "Автоответчик"
#define LG_MNUILUON       "Режим Ilum."
*/
...
#define LG_INVIS            "Neviditeѕnэ"
#define LG_VIBRA_REM        "Vibra prip."
#define LG_CLAER_ALL_CHAT   "Vyиistiќ chat"
#define LG_AUTOMSG          "Auto MSG"
#define LG_SHOW_XSTATE_TIME "Ukбzaќ X-Status/Иas"
#define LG_CONFIG           "Nastavenia"
#define LG_CONFIG_MOD       "Nastavenia mуdu"
#define LG_PING             "Ping"
#define LG_HIHE_LOCK        "Zablokovaќ"
#define LG_IDLE             "Idle"
#define LG_USERMENU         "Pouћ. Menu" 
