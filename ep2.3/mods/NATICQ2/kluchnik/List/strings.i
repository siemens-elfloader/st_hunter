...
void log(char *fname, void *text)
{
  ...
  hFile = fopen(fname,2 + 0x100 + 8,0x80+0x100, &io_error);
  if(hFile!=-1)
  {
...
void LogFreeRam(char *text)
{
  ...
  strcat(log_path,"\\ram.log");
        
  sprintf(s,"%s %d kbytes\n",text, ram/1024);
  log(log_path,s);
}
...
const TUNICODE2CHAR unicode2char[]=
{
  ...
  0x40F,'_',0x8F,'_', 
  0x40E,0xF6,0xA1,'_', 
  0x408,0x4A,0xA3,0x4A, 
  0x409,0x83,0xA5,0xBD, 
  0x401,0xF0,0xA8,0xB3, 
  0x404,0xF2,0xAA,0xB4, 
  0x407,0xF4,0xAF,0xB7, 
  0x406,0x49,0xB2,0xB6, 
  0x405,0x53,0xBD,0x53, 
  ...
  0x45F,'_',0x9F,'_', 
  0x45E,0xF7,0xA2,'_', 
  0x458,0x6A,0xBC,0x6A, 
  0x491,0xA3,0xB4,0xAD, 
  0x451,0xF1,0xB8,0xA3, 
  0x454,0xF3,0xBA,0xA4, 
  0x457,0xF5,0xBF,0xA7, 
  0x456,0x69,0xB3,0xA6, 
  0x455,0x73,0xBE,0x73, 
  0x0A0,'_',0xA0,0x20, 
  0x0A4,'_',0xA4,0xFD, 
  0x0A6,'_',0xA6,'_', 
