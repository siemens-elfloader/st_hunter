...
__root const CFG_HDR cfghdr2={CFG_LEVEL,"Hosts and paths",1,0};
  ...
  __root const char NATICQ_HOST[128]="gate1.himoza.org;perk11.info;cbsie.dyndns.info";
...
//show status on idle
   __root const CFG_HDR cfghdr4_81={CFG_CBOX,"Show icon on idle",0,2};
   __root const int ICON_IDLE_ENABLE = 0;
   __root const CFG_CBOX_ITEM cfgcbox4_7[2]={"No","Yes"};
...
//First letter when typing
  ...
  //First letter when typing
  __root const CFG_HDR cfghdr4_10={CFG_CBOX,"Show loopback",0,2};
  __root const int IS_SHOW_LOOPBACK = 1;
  __root const CFG_CBOX_ITEM cfgcbox4_11[2]={"No","Yes"};   
...
__root const CFG_HDR cfghdrCL_1={CFG_LEVEL,"Contact List",1,0};
    ...
    //Sorting
     ...
     //CONTACT LIST HEADER__root const CFG_HDR cfghdr_s1={CFG_LEVEL,"CL Header",1,0};        
...
#define keys LG_NOT_ACTION,LG_SOUND,LG_VIBRA,LG_INVIS,LG_VIBRA_REM,LG_CLAER_ALL_CHAT,LG_AUTOMSG,LG_CONFIG,LG_PING,LG_HIHE_LOCK,LG_IDLE,LG_MNUSHOWOFF,LG_MNUSHOWGROUP
#define key_n 13
  
  
    //Action on # button in contact list
      __root const CFG_HDR cfghdr78_4520={CFG_CBOX,"Действие на # в КЛ",0,3};
      __root const int ActionResh = 1;
      __root const CFG_CBOX_ITEM cfgcbox_668_z[3]={"Ничего","Очистить выделенный чат","Перейти на сообщение"};
      
        __root const CFG_HDR cfghdr99_3_22={CFG_CBOX,"Действие на * в КЛ",0,key_n+1};
        __root const int Action_by_Star = 13;
        __root const CFG_CBOX_ITEM cfgcbox99_420[key_n+1]={ keys,"Перейти на сообщение" };      
  ...
  //{"Без действия","Звук","Вибра","Инвиз","Реж.напоминания","Очистить чаты","Автоответчик","Показ.хстат/время","Конфиг","Конфиг мода","Пинг","Заблокировать","На гэ","Меню юзера"}
    __root const CFG_HDR cfghdr99_1={CFG_LEVEL,"Длинное нажатие",1,0};
      ...
      //Long press vol down button in chat
        ...
        __root const CFG_HDR cfghdr99_3_0={CFG_CBOX,"Длинная 0 в КЛ",0,key_n};
        __root const int longAct_0 = 8;
        __root const CFG_CBOX_ITEM cfgcbox99_4_0[key_n]={ keys };
  
        __root const CFG_HDR cfghdr99_3_1={CFG_CBOX,"Длинная 1 в КЛ",0,key_n};
        __root const int longAct_1 = 1;
        __root const CFG_CBOX_ITEM cfgcbox99_4_1[key_n]={keys};
  
        __root const CFG_HDR cfghdr99_3_2={CFG_CBOX,"Длинная 2 в КЛ",0,key_n};
        __root const int longAct_2 = 2;
        __root const CFG_CBOX_ITEM cfgcbox99_4_2[key_n]={ keys };
        
        __root const CFG_HDR cfghdr99_3_3={CFG_CBOX,"Длинная 3 в КЛ",0,key_n};
        __root const int longAct_3 = 3;
        __root const CFG_CBOX_ITEM cfgcbox99_4_3[key_n]={ keys };
        
        __root const CFG_HDR cfghdr99_3_4={CFG_CBOX,"Длинная 4 в КЛ",0,key_n};
        __root const int longAct_4 = 4;
        __root const CFG_CBOX_ITEM cfgcbox99_4_4[key_n]={ keys };
        
        __root const CFG_HDR cfghdr99_3_5={CFG_CBOX,"Длинная 5 в КЛ",0,key_n};
        __root const int longAct_5 = 5;
        __root const CFG_CBOX_ITEM cfgcbox99_4_5[key_n]={ keys };
        
        __root const CFG_HDR cfghdr99_3_6={CFG_CBOX,"Длинная 6 в КЛ",0,key_n};
        __root const int longAct_6 = 11;
        __root const CFG_CBOX_ITEM cfgcbox99_4_6[key_n]={ keys };
        
        __root const CFG_HDR cfghdr99_3_7={CFG_CBOX,"Длинная 7 в КЛ",0,key_n};
        __root const int longAct_7 = 12;
        __root const CFG_CBOX_ITEM cfgcbox99_4_7[key_n]={ keys };
        
        __root const CFG_HDR cfghdr99_3_8={CFG_CBOX,"Длинная 8 в КЛ",0,key_n};
        __root const int longAct_8 = 7;
        __root const CFG_CBOX_ITEM cfgcbox99_4_8[key_n]={ keys };
        
        __root const CFG_HDR cfghdr99_3_9={CFG_CBOX,"Длинная 9 в КЛ",0,key_n};
        __root const int longAct_9 = 0;
        __root const CFG_CBOX_ITEM cfgcbox99_4_9[key_n]={ keys };
        
        __root const CFG_HDR cfghdr99_3_10={CFG_CBOX,"Длинная # в КЛ",0,key_n};
        __root const int longAct_10 = 9;
        __root const CFG_CBOX_ITEM cfgcbox99_4_10[key_n]={ keys };
        
        __root const CFG_HDR cfghdr99_3_11={CFG_CBOX,"Длинная * в КЛ",0,key_n};
        __root const int longAct_11 = 10;
        __root const CFG_CBOX_ITEM cfgcbox99_4_11[key_n]={ keys };     
