...
//перейдем к модульному режиму...

#define ANTISPAM  //простенький антиспам..блокирует популярные сообщения Auth Req: ...надоело получать такие...
//#define NEW_HEADER_TO_CHAT //заголовок в чате графический
#define UP_BY_UNLOCK //всплыть натасе после разлочки клавы
//#define START_OFFLINE //стартовать асю без подключения (для отладки)
#define AUTOANSWER //Автоответчик

#define CLV_LIST //загрузка списка видящих
#define DYNMENU  //динамичееское меню, уходим от статического...
