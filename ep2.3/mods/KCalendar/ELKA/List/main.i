...
extern const char CLR_BORD[4];

extern const char CLR_BACK[4];
extern const char CLR_CURDAY[4];
extern const unsigned int X_POS ;
extern const unsigned int Y_POS ;
extern const int FONT;

extern const char CLR_1[4];
extern const char CLR_2[4];
extern const char CLR_3[4];
extern const char CLR_4[4];
extern const char CLR_5[4];
extern const char CLR_6[4];
extern const char CLR_7[4];
extern const char CLR_8[4];
extern const char CLR_9[4];
extern const char CLR_10[4];
extern const char CLR_11[4];
extern const char CLR_12[4];
extern const char CLR_13[4];
extern const char CLR_14[4];
extern const char CLR_15[4];
extern const char CLR_16[4];
extern const char CLR_17[4];
extern const char CLR_18[4];
extern const char CLR_19[4];
extern const char CLR_20[4];
extern const char CLR_21[4];
extern const char CLR_22[4];
extern const char CLR_23[4];
extern const char CLR_24[4];
extern const char CLR_25[4];
extern const char CLR_26[4];
extern const char CLR_27[4];
extern const char CLR_28[4];
extern const char CLR_29[4];
extern const char CLR_30[4];
extern const char CLR_31[4];
...
const char *color(int i)
{
  switch(i)
  {
    ...
    default : return GetPaletteAdrByColorIndex(25);
...
void DrawCal()
{
  ...
  GetDateTime(&date,0);
  date.day = 1;
  int daypos = GetWeek(&date);


  int pos_x = daypos * space + X_POS; 
  int pos_y = 5 + Y_POS; 
  WSHDR *ws = AllocWS(32);
  GetDateTime(&date,0);
  ...
  for(int i = 0 ; i < count_days[date.month] + 1 ; i++)
  {
    ...
    DrawString(ws,X_POS+2,Y_POS+1,X_POS+Get_WS_width(ws,FONT)+5 ,Y_POS+GetFontYSIZE(FONT)+1,8,32,GetPaletteAdrByColorIndex(0),GetPaletteAdrByColorIndex(1));
    
    
    DrawRectangle(pos_x+2,pos_y+GetFontYSIZE(FONT),pos_x+space,pos_y+GetFontYSIZE(FONT)*2,0,0 ,color(i+1));
    
    wsprintf(ws,"%d",i+1);
    DrawString(ws,pos_x,pos_y+GetFontYSIZE(FONT),pos_x+space,pos_y+GetFontYSIZE(FONT)*2+1,8,32+4,((i+1)==date.day) ? CLR_CURDAY : GetPaletteAdrByColorIndex(0),GetPaletteAdrByColorIndex(1));
    
    pos_x += space;
    daypos++;
    if(daypos >= 7)
    {
       pos_y += GetFontYSIZE(FONT)+1;
       pos_x = X_POS;
       daypos = 0;
    }
  }  
