...
char *successed_config_filename=(char *)"";
...
void InitConfig()
{
    ...
    if(LoadConfigData("0:\\ZBin\\etc\\ImgAView3.bcfg", __CONFIG(0, cfghdr0)) < 0 )
    {
        LoadConfigData("4:\\ZBin\\etc\\ImgAView3.bcfg", __CONFIG(0, cfghdr0));
    }
}
