...
__root const CFG_HDR cfghdr4={CFG_CBOX,"CFG_SMART_ROTATE", 0, 2};
__root const int CFG_SMART_ROTATE = 0;
__root const CFG_CBOX_ITEM cfgcbox1_2[2]={"OFF", "ON"};

 __root const CFG_HDR cfghdr5 = {CFG_UINT, "CFG_MAX_RESOLUTION", 1, 2048};
 __root const unsigned int CFG_MAX_RESOLUTION = 1024;
/*
