...
void InitConfig(void)
{
	...
	if (LoadConfigData("0:\\Zbin\\Etc\\APD.bcfg", __CONFIG(0, cfghdr0), successed_config_filename) == -1)
		LoadConfigData("4:\\Zbin\\Etc\\APD.bcfg", __CONFIG(0, cfghdr0), successed_config_filename);
}
