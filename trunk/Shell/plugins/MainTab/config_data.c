...
__CFG_BEGIN(0)
	...
	__root const unsigned int cfg_use_ls = 0;
	...
	__root const unsigned int cfg_use_enter = 0;
	
	__root const CFG_HDR cfghdr0_6 = {CFG_STR_WIN1251, "Enter button shortcut", 0, 31};
