...
HEADER_DESC acgd_hdr={0,0,0,0,NULL,(int)"���������� ��������",LGP_NULL};
...
{
  {S_ICONS+ICON_ALL_CAN_SEE,         (int)LG_ALL_CAN_SEE,           LGP_NULL,0,0,MENU_FLAG3,MENU_FLAG2},
  {S_ICONS+ICON_INVISLIST_CANNOT_SEE,(int)LG_INVISLIST_CANNOT_SEE,  LGP_NULL,0,0,MENU_FLAG3,MENU_FLAG2},
  {S_ICONS+ICON_CONTACTLIST_CAN_SEE, (int)LG_CONTACTLIST_CAN_SEE,   LGP_NULL,0,0,MENU_FLAG3,MENU_FLAG2},
  {S_ICONS+ICON_VISLIST_CAN_SEE,     (int)LG_VISLIST_CAN_SEE,       LGP_NULL,0,0,MENU_FLAG3,MENU_FLAG2},
  {S_ICONS+ICON_NOBODY_CAN_SEE,      (int)LG_NOBODY_CAN_SEE,        LGP_NULL,0,0,MENU_FLAG3,MENU_FLAG2}
};
...
static HEADER_DESC private_list_HDR={0,0,0,0,0,0,LGP_NULL};
...
static HEADER_DESC mmanage_cl_HDR={0,0,0,0,0,0,LGP_NULL};
