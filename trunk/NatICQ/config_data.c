...
__root const CFG_HDR cfghdr2={CFG_LEVEL,"Hosts and paths",1,0};
  ...
  __root const char NATICQ_HOST[128]="ig.boba.su;ig1.boba.su;ig2.boba.su;ig3.boba.su;ig4.boba.su;ig5.boba.su";
...
//First letter when typing
  ...
  //
  //Twitch - счетчик непрочитанных для каждого контакта в кл
  __root const CFG_HDR cfghdr4_13={CFG_CHECKBOX,"Count messages in CL",0,2};
  __root const int cl_unreaded_cnt=1;
...
#ifdef ELKA
  __root const CFG_HDR cfghdr8_7={CFG_CBOX,"Blink SLI",0,4};
  __root const int SLI_State = 0;
  __root const CFG_CBOX_ITEM cfgcbox8_7[4]={"No","Shine","Blink slow","Blink fast"};
#endif
...
//  <tridog/>
//  2.01.2011. Автостатус.

__root const CFG_HDR cfghdr10={CFG_LEVEL,"Autostatus",1,0};
